...
export class CertificateService {
    ...
    return new Promise(async (resolve, reject) => {
      try {
        ...
        doc.fontSize(8)
           .fillColor('#9CA3AF')
           .text(
             'Este certificado fue generado automáticamente por BuscartPro. Para verificar su autenticidad, escanee el código QR.',
             50,
             doc.page.height - 40,
   ...
   */
  static generateCertificateCode(eventId: number, attendeeId: string): string {
