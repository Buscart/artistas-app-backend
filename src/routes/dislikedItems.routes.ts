...
dislikedItemsRoutes.post(
  '/',
  authMiddleware,
  asyncHandler(dislikedItemsController.addDislikedItem)
);

// Eliminar un item de "no me interesa"
dislikedItemsRoutes.delete(
  '/:type/:id',
  authMiddleware,
  asyncHandler(dislikedItemsController.removeDislikedItem)
);

// Obtener todos los items de "no me interesa"
dislikedItemsRoutes.get(
  '/',
  authMiddleware,
  asyncHandler(dislikedItemsController.getDislikedItems)
);
