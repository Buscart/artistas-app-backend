...
// Crear un nuevo post
router.post('/', authMiddleware, memoryUpload.array('media', 10), // Permitir hasta 10 archivos
validateRequest(createPostSchema, 'body'), PostsController.createPost);
...
// Actualizar un post
router.put('/:id', authMiddleware, validateRequest(createPostSchema.partial(), 'body'), PostsController.updatePost);
// Eliminar un post
router.delete('/:id', authMiddleware, PostsController.deletePost);
// Añadir medios a un post existente
router.post('/:id/media', authMiddleware, memoryUpload.array('media', 10), PostsController.addMediaToPost);
// Dar like a un post
