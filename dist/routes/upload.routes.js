 ...
 */
uploadRoutes.post('/image', authMiddleware, uploadRateLimit, upload.single('file'), asyncHandler(async (req, res) => {
    if (!req.file) {
 ...
 */
uploadRoutes.post('/images', authMiddleware, uploadRateLimit, upload.array('files', 10), // Máximo 10 archivos
