...
export const campaignsController = {
    ...
    async getCompanyCampaigns(req, res) {
        try {
    ...
    async createCampaign(req, res) {
        try {
            ...
            const { companyId, title, description, shortDescription, campaignType, compensationType, budget, compensationDetails, requirements, deliverables, targetAudience, platforms, startDate, endDate, applicationDeadline, locationType, location, city, featuredImage, gallery, maxParticipants, minFollowers, categories, tags, isPublic, } = req.body;
    ...
    async applyToCampaign(req, res) {
        try {
            ...
            const { message, portfolio, socialLinks, expectedDelivery, followerCount, previousWork, } = req.body;
            if (!message) {
