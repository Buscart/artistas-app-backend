...
export const venuesController = {
    ...
    async getAllVenues(req, res) {
        try {
            ...
            if (venue_type) {
                conditions.push(eq(venues.venueType, venue_type));
            }
            ...
            const transformedVenues = paginatedVenues.map((venue) => ({
                ...
                images: venue.multimedia?.gallery || venue.multimedia?.images || [],
    ...
    async getVenuesByCompany(req, res) {
        try {
