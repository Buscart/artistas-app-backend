...
class EventController {
    ...
    static async getUpcomingEvents(req, res) {
        try {
            ...
            const upcomingEvents = await EventService.getUpcomingEvents(limit);
    ...
    static async registerForEvent(req, res) {
        try {
            ...
            const userId = req.user.id;
            const attendee = await EventService.registerForEvent(parseInt(eventId), userId, ticketTypeId);
            res.status(201).json({
                success: true,
     ...
     */
    static async getAttendeeStats(req, res) {
        try {
            const { eventId } = req.params;
            const userId = req.user?.id;
     ...
     */
    static async approveAttendee(req, res) {
        try {
            if (!req.user) {
                return res.status(401).json({ error: 'No autorizado' });
            }
            ...
            const userId = req.user.id;
            const attendee = await EventService.approveAttendee(parseInt(eventId), parseInt(attendeeId), userId);
            res.status(200).json({
                success: true,
     ...
     */
    static async rejectAttendee(req, res) {
        try {
            if (!req.user) {
                return res.status(401).json({ error: 'No autorizado' });
            }
            const { eventId, attendeeId } = req.params;
            const userId = req.user.id;
            const attendee = await EventService.rejectAttendee(parseInt(eventId), parseInt(attendeeId), userId);
            res.status(200).json({
                success: true,
     ...
     */
    static async moveToWaitlist(req, res) {
        try {
            if (!req.user) {
                return res.status(401).json({ error: 'No autorizado' });
            }
            const { eventId, attendeeId } = req.params;
            const userId = req.user.id;
            const attendee = await EventService.moveToWaitlist(parseInt(eventId), parseInt(attendeeId), userId);
            res.status(200).json({
                success: true,
     ...
     */
    static async moveFromWaitlist(req, res) {
        try {
            if (!req.user) {
                return res.status(401).json({ error: 'No autorizado' });
            }
            const { eventId, attendeeId } = req.params;
            const userId = req.user.id;
            const attendee = await EventService.moveFromWaitlist(parseInt(eventId), parseInt(attendeeId), userId);
            res.status(200).json({
                success: true,
    ...
    static async checkInAttendee(req, res) {
        try {
            ...
            const { eventId, attendeeId } = req.params;
            const userId = req.user.id;
            const attendee = await EventService.checkInAttendee(parseInt(eventId), parseInt(attendeeId), userId);
            res.status(200).json({
                success: true,
    ...
    static async undoCheckIn(req, res) {
        try {
            ...
            const { eventId, attendeeId } = req.params;
            const userId = req.user.id;
            const attendee = await EventService.undoCheckIn(parseInt(eventId), parseInt(attendeeId), userId);
            res.status(200).json({
                success: true,
    ...
    static async respondToReview(req, res) {
        try {
            ...
            const updatedReview = await EventService.respondToReview(parseInt(eventId), parseInt(reviewId), userId, response);
            res.status(200).json({
                success: true,
     ...
     */
    static async getAttendedEvents(req, res) {
        try {
            if (!req.user) {
                return res.status(401).json({ error: 'No autorizado' });
            }
    ...
    static async generateCertificate(req, res) {
        try {
            ...
            const { eventId } = req.params;
            const userId = req.user.id;
            const format = req.query.format; // 'pdf' o 'json'
